	...
	<body>
		<div id="app">
			...
			<div class="recommend" :style='{"padding":"10px 7%","margin":"0px auto","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
				<div class="category-1" :style='{"border":"0px solid #f6f6f6","padding":"20px 16px 0px 0","margin":"20px auto 0","alignSelf":"flex-start","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"360px","justifyContent":"space-between","height":"auto","order":"2"}'>
					<div class="category-search" :index="-1" :style='swiperIndex == -1 ? {"cursor":"pointer","margin":"0 0 20px","borderColor":"#76b39d","color":"#fff","textAlign":"center","borderRadius":"0px","background":"#76b39d","borderWidth":"0px","width":"48%","fontSize":"16px","lineHeight":"40px","borderStyle":"solid","height":"40px"} : {"cursor":"pointer","padding":"0 20px","margin":"0 0 20px","borderColor":"#eee","color":"#333","textAlign":"center","float":"left","borderRadius":"0px","background":"#f9f9f9","borderWidth":"0px","width":"48%","fontSize":"16px","lineHeight":"40px","borderStyle":"solid","height":"40px"}'>全部</div>
					<div class="category-search" :index="index" :style='swiperIndex == index ? {"cursor":"pointer","margin":"0 0 20px","borderColor":"#76b39d","color":"#fff","textAlign":"center","borderRadius":"0px","background":"#76b39d","borderWidth":"0px","width":"48%","fontSize":"16px","lineHeight":"40px","borderStyle":"solid","height":"40px"} : {"cursor":"pointer","padding":"0 20px","margin":"0 0 20px","borderColor":"#eee","color":"#333","textAlign":"center","float":"left","borderRadius":"0px","background":"#f9f9f9","borderWidth":"0px","width":"48%","fontSize":"16px","lineHeight":"40px","borderStyle":"solid","height":"40px"}' v-for="(item,index) in categoryList" :key="index">
						{{categoryList[index]}}
					</div>
				</div>
				...
				<form class="layui-form filter" :style='{"padding":"0px","margin":"30px auto 10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"center","height":"auto"}'>
					...
					<div :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}' class="item-list">
						...
						<select name="xiangmufenlei" id="xiangmufenlei" lay-filter="xiangmufenlei">
							...
							<option v-for="(item,index) in xiangmufenleiOptions" v-bind:key="index" :value="item">{{item}}</option>
						</select>
					</div>
				...
				<div :style='{"width":"100%","margin":"0px auto","minWidth":"1050px","background":"none","flex":"1","order":"3"}' class="lists">
					...
					<div :style='{"padding":"20px 0 0","margin":"0","overflow":"hidden","flexWrap":"wrap","background":"none","display":"block","width":"100%","justifyContent":"space-between","height":"auto"}' class="list list-1">
						<div :style='{"border":"0px solid #eae6e6","padding":"10px","margin":"0px 0 20px 1.8%","borderRadius":"10px","flexWrap":"wrap","background":"rgba(245,245,245,.0)","display":"flex","width":"31.5%","position":"relative","float":"left","justifyContent":"space-between","height":"auto"}' @click="jump('../xiangmuxinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item animation-box">
			...
			layui.use(['form', 'layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate', 'slider'], function() {
				...
				http.request('config/list', 'get', {
        			...
        			http.request(`option/xiangmufenlei/xiangmufenlei`,'get',{},(res)=>{
                			vue.xiangmufenleiOptions = res.data
				...
				//类型搜索
				  ...
				  // 获取列表数据
				  http.request('option/xiangmufenlei/xiangmufenlei', 'get', {}, function(res) {
				...
				if(vCategory!='' && category!='全部') {
					...
					// 获取列表数据
					http.request('xiangmuxinxi/list', 'get', param, function(res) {
