	...
	<body>
		<div id="register" class="register" :style='{"minHeight":"100vh","padding":"10px 0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20230421/09c4dc2482544bbe8e5bc07107662968.jpg) no-repeat center bottom / 100% 100%,#fff","display":"flex","width":"100%","justifyContent":"center"}'>
			<form id="registerForm" class="layui-form login-form" :style='{"padding":"20px 0px 140px","boxShadow":"0px 26px 26px -26px #333","margin":"10px auto","borderColor":"#eee","display":"flex","justifyContent":"flex-start","minHeight":"550px","outline":"0px solid #eee","borderRadius":"4px","outlineOffset":"0px","flexWrap":"wrap","background":"url(),#fff","borderWidth":"0px","width":"720px","position":"relative","borderStyle":"solid","height":"auto"}' lay-filter="myForm">
				...
				<div v-if="true" :style='{"boxShadow":"inset 0px 0px 0px 0px #c5f1c0","margin":"0 auto 30px","borderColor":"#e6f5ef","color":"#155e63","textAlign":"center","borderRadius":"0","background":"none","borderWidth":"1px 1px 4px","width":"80%","lineHeight":"50px","fontSize":"24px","borderStyle":"solid","fontWeight":"600","height":"50px"}'>老师注册</p></div>
			

				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
					<div v-if="true" :style='{"color":"#459075","left":"-154px","textAlign":"right","width":"150px","lineHeight":"44px","fontSize":"18px","position":"absolute"}'>老师账号：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#efedd6","color":"#666","borderRadius":"0px","borderWidth":"1px","background":"#fdfdf6","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="laoshizhanghao" name="laoshizhanghao" placeholder="请输入老师账号" autocomplete="off" class="layui-input">
				</div>
				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
					<div v-if="true" :style='{"color":"#459075","left":"-154px","textAlign":"right","width":"150px","lineHeight":"44px","fontSize":"18px","position":"absolute"}'>老师姓名：</div>
					<input :style='{"padding":"0 10px","boxShadow":"inset 0px 0px 0px 0px #c5f1c0","outline":"none","borderColor":"#efedd6","color":"#666","borderRadius":"0px","borderWidth":"1px","background":"#fdfdf6","width":"100%","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="text"   id="laoshixingming" name="laoshixingming" placeholder="请输入老师姓名" autocomplete="off" class="layui-input">
				</div>
                <div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
                ...
                <div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
					<div v-if="true" :style='{"color":"#459075","left":"-154px","textAlign":"right","width":"150px","lineHeight":"44px","fontSize":"18px","position":"absolute"}'>性别：</div>
				...
				<div :style='{"width":"60%","padding":"0","margin":"0 auto 10px","position":"relative","height":"auto"}' class="form-item">
					<div v-if="true" :style='{"color":"#459075","left":"-154px","textAlign":"right","width":"150px","lineHeight":"44px","fontSize":"18px","position":"absolute"}'>手机号：</div>
