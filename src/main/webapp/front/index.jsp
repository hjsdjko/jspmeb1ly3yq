...
<html>
	<head>
		...
		<title>基于JSP的高校科研项目信息管理系统设计与实现</title>
	...
	<style type="text/css">
		...
		#navs.horizontal li a {
						...
						margin: 0 4px;
						color: #fff;
						background: url(http://codegen.caihongy.cn/20230420/12e413df39b349c39414013767ced84f.png) no-repeat left top / auto 100%,url(http://codegen.caihongy.cn/20230420/53b55c7ee6974e97be4cb3b77f5186e5.png) no-repeat right top / auto 100%,url(http://codegen.caihongy.cn/20230420/d1e7d6e359d343d596cea71a12eaa396.png) repeat-x left top / auto 100%;
						font-size: 18px;
						border-color: #2cb34a;
	...
	<body>
	<div id="apps">
		<div id="header" :style='{"padding":"0 0 16px","margin":"0 auto","borderColor":"#666","alignItems":"center","display":"flex","right":"0","justifyContent":"space-between","overflow":"hidden","top":"0","left":"0","background":"linear-gradient(36deg, rgba(118,179,157,1) 0%, rgba(185,242,221,1) 50%, rgba(118,179,157,1) 100%),#76b39d","borderWidth":"0 0 0px","width":"100%","position":"relative","borderStyle":"solid","height":"64px","zIndex":"1002"}'>
			...
			<div v-if="projectName" :style='{"padding":"0 0 0px","margin":"0 auto","borderColor":"#666","color":"#333","alignItems":"flex-end","textAlign":"center","display":"flex","justifyContent":"center","background":"none","borderWidth":"0 0 0px","width":"calc(86% - 0px)","fontSize":"24px","borderStyle":"solid","fontWeight":"500","height":"44px"}' class="nav-top-title">{{projectName}}</div>
			<div :style='{"width":"180px","margin":"16px 0 0","position":"absolute","right":"7%","alignItems":"center","display":"flex"}'>
				<div :style='{"color":"#fff","fontSize":"14px","display":"inline-block"}'></div>
				<button v-if="!Token" :style='{"cursor":"pointer","padding":"0 16px","margin":"0 0 0 10px","borderColor":"#999","color":"#fff","display":"inline-block","borderRadius":"0px","background":"none","borderWidth":"0 0px 0 0","fontSize":"16px","lineHeight":"20px","borderStyle":"solid","height":"20px"}' @click="jumpLogin('./pages/login/login.jsp')">登录/注册</button>
				<button v-if="Token" :style='{"border":"0px solid #fff","cursor":"pointer","padding":"0 16px","margin":"0px","color":"#fff","borderRadius":"0px","background":"none","display":"inline-block","fontSize":"16px","lineHeight":"30px","height":"30px"}' @click="logout()">退出</button>
			</div>
		</div>
		
		
		<!-- 横向 -->
		<div id="navs" class="horizontal" :style='{"width":"100%","padding":"0","margin":"0px auto 0","textAlign":"center","background":"#fff","height":"auto"}'>
			<ul class="layui-nav" lay-bar="disabled" :style='{"border":"0","padding":"20px 0","listStyle":"none","margin":"0","textAlign":"center","background":"none","width":"100%","position":"relative","zIndex":"11"}'>
				...
				<li class='layui-nav-item' v-if="chatFlag"><a href="javascript:chatTap()" class="menumain"><i class="layui-icon">&#xe677;</i><span>留言建议</span></a></li>
