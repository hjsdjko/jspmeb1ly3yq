...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<div class="item-label">老师账号</div> 
					<input  id="laoshizhanghao" name="laoshizhanghao"  placeholder="请输入老师账号" class="form-control-i">
				</div>
				<div class="list-item">
					<div class="item-label">老师姓名</div> 
					<input  id="laoshixingming" name="laoshixingming"  placeholder="请输入老师姓名" class="form-control-i">
				</div>
				<div class="list-item">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "laoshi/register";
				$.ajax({ 
					type: "POST",
					url: url,
