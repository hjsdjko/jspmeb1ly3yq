...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">老师管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>老师管理</span></li>
				<li class="breadcrumb-item-two"><span>老师列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>老师账号</label>
					<input type="text" id="laoshizhanghaoSearch" class="form-control form-control-sm" placeholder="请输入老师账号" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#laoshizhanghaoSearch').val() != null && $('#laoshizhanghaoSearch').val() != ''){
				searchForm.laoshizhanghao ="%" +  $('#laoshizhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("laoshi/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				laoshizhanghao : searchForm.laoshizhanghao,	
			},(res)=>{
				if(res.code == 0){
					clear();
