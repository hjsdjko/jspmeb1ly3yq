...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">项目申请管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>项目申请列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
			...
			<table id="tableId" class="table table-bordered">
				<thead>
					<tr>
						...
						<th onclick="sort('chengyuanmingdan')">成员名单<i id="chengyuanmingdanIcon" class="fa fa-sort"></i></th>
						<th>研究目的</th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "项目流程"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'xiangmuliucheng','是','','')");
			if(crossBtnControl('项目流程') == true){
		...
		function sh(){
			...
			httpJson("xiangmushenqing/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
	...
	// 导出
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xiangmushenqing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xiangmushenqing");
