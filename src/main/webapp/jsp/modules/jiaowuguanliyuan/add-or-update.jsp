...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑教务管理员</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>教务管理员管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑教务管理员</span></li>
			</ol>
		</div>
	...
	<script>
		...
		var tableName = "jiaowuguanliyuan";
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jiaowuguanliyuan/info/" + id,
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				if(crossrefid && crossuserid) {
					...
					http("jiaowuguanliyuan/page","GET",{
						page:1,
						limit:10,
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jiaowuguanliyuan/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jiaowuguanliyuan/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("jiaowuguanliyuan"+colName,"GET",{
				tableName: "jiaowuguanliyuan",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
