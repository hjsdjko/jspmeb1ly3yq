...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">项目分类管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>项目分类管理</span></li>
				<li class="breadcrumb-item-two"><span>项目分类列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
	...
	<script>
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("xiangmufenlei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("xiangmufenlei"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"xiangmufenlei");
